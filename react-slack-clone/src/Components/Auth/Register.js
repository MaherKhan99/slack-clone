...
class Register extends React.Component {
    ...
    isFormValid = () => {
        ...
        if(this.isFormEmpty(this.state)){
            ...
            this.setState({errors: errors.concat(error)}); //sets state to errors array with created error concatenated to it
            return false;
        ...
        firebase
            ...
            .then(createdUser => {
                ...
                createdUser.user.updateProfile({
                    ...
                    photoURL: `http://gravtar.com/avatar/${md5(createdUser.user.email)}?d=indeticon`
                })
                .then(() => {
