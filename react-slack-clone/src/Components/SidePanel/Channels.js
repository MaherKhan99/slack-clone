        ...
        return (
            <React.Fragment>
                ...
                <Modal basic open={modal} onClose={this.closeModal}>
                    ...
                    <Modal.Actions>
                        <Button color="green" inverted onClick={this.handleSubmit}><Icon name="checkmark"/></Button> Add
                        <Button color="red" inverted onClick={this.closeModal}><Icon name="remove"/></Button> Cancel
                    </Modal.Actions>
                </Modal>
            </React.Fragment>
        );
